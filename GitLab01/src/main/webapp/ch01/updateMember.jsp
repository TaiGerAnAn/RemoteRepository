...
<body>
	...
	<div class='center'>
		...
		<Form class='center' Action="updateMember.do" method="POST">
			...
			<input type="hidden" name="pk" value="${mb.pk}"> <input
				type="hidden" name="id" value="${mb.id}${param.id}"> <input
			...
			<Table>
				...
				<TR>
					...
					<TD align="LEFT"><input type="text" name="name"
						value="${mb.name}${param.name}" size="30"> <font
						color='red' size='-3'>${error.name}</font></TD>
				</TR>

				<TR>
					<TD align="RIGHT">密碼：</TD>
					<TD align="LEFT"><input type="text" name="pswd"
						value="${mb.pswd}${param.pswd}"> <font color='red'
						size='-3'>${error.pswd}</font></TD>
				</TR>
		...
		<p />
		<small>&lt;&lt;<a href="<c:url value='/ch01/queryMember.do'/>">回上一頁</a>&gt;&gt;
		</small>
	</div>
</body>
